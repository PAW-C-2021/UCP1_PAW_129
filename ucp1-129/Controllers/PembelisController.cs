...
namespace ucp1_129.Controllers
{
    public class PembelisController : Controller
    {
        ...
        public PembelisController(ApotekerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPembeli,Nama,Umur,JenisKelamin")] Pembeli pembeli)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPembeli,Nama,Umur,JenisKelamin")] Pembeli pembeli)
        {
